...
Filename: "{app}\vcredist_x64.exe"; Check: VCRedistNeedsInstall; Parameters: "/qb"; WorkingDir: {app}; StatusMsg: Installing Micosoft Visual C/C++ runtime ...
...
begin
  ...
  Result := not (VCVersionInstalled(VC_2013_REDIST_X64_MIN) and 
